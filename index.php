        ...
        <!-- # intro
            ...
            <section id="intro" class="s-intro target-section">
                    ...
                    <div class="column lg-12 s-intro__content-inner grid-block grid-16">
                        ...
                        <div class="s-intro__content-text">
                            ...
                            <h1 class="s-intro__content-title">
                                I'm Imam Darmawan <br>
                                a Fresh Graduated <br>
                                of Information Technology.
                            </h1>                            

                            <div class="s-intro__content-btns">
                                <a class="btn" href="./document/Resume_ImamDarmawan_EN.pdf" download>My Resume (EN)</a>
                                <a class="smoothscroll btn btn--stroke" href="#footer">My Resume (ID)</a>
                ...
                <ul class="s-intro__social social-list">
                    <li>
                        <a href="https://www.instagram.com/imamd_30/">
                    ...
                    <li>
                        <a href="https://dribbble.com/imam_d">
                    ...
                    <li>
                        <a href="https://github.com/hyoudou123">
                ...
                <div class="s-intro__content-media">                               
                    <img src="images/profile.jpg" srcset="images/profile.jpg 1x, images/profile.jpg 2x" alt="">
                ...
                <div class="row s-about__content">
                    <div class="column xl-12">    
                        ...
                        <p class="attention-getter">
                            Hello, I'm Imam Darmawan, a fresh graduate from Universitas Indraprasta PGRI. Over the past 2 years, I have worked as a Junior Programmer and UI/UX Designer. I focus on creating functional, visually appealing, and user-friendly applications and websites. My skills include HTML, CSS, PHP, as well as design tools like Figma and Adobe XD.
                        </p>

                        <p class="attention-getter">
                            I am passionate about continuously learning and improving my skills, always seeking opportunities to provide creative solutions in every project. Outside of work, I enjoy exploring new technologies and collaborating with teams to create outstanding user experiences.
                        </p>
                        ...
                        <div class="grid-list-items s-about__blocks">
                            ...
                            <div class="grid-list-items__item s-about__block">
                                ...
                                <ul class="s-about__list">
                                    <li>
                                        Alan Creative
                                        <span>Internship UI/UX Designer</span>
                                    </li>
                                    <li>
                                        PT. Anilo Adikarya Sentosa
                                        <span>Junior Programmer & UI/UX Designer</span>
                                    </li>
                                    <li>
                                        PT. National Data Integrator
                                        <span>Internship Web Programmer</span>
                                    </li>
                                </ul>
                                ...
                                <ul class="s-about__list">
                                    <li>
                                        <p>
                                            ...
                                            <span>Indraprasta PGRI University (2016 — 2019)</span>
                                        </p>                                        
                                    </li>
                                    <li>
                                        <p>
                                            Software Engineering
                                            <span>SMK Taruna Bhakti (2016 — 2019)</span>
                                        </p>
                                    </li>
                                </ul>
                            </div> <!--end s-about__block -->
            ...
            <section id="portfolio" class="s-works target-section">
                ...
                <div class="row">
                    <div class="column xl-12">
                        <div class="section-header" data-num="02">
                            <h2 class="text-display-title">Selected Portfolio.</h2>
                        </div> <!-- end section-header -->
                    </div>
                </div>
                ...
                <div class="row folio-entries">
                    ...
                    <div class="column entry">
                        <a href="images/portfolio/dating_app.png" class="entry__link glightbox" data-glightbox="title: Dating Apps; description: .entry__desc-01">
                            <div class="entry__thumb">
                                <img src="images/portfolio/dating_app.png" srcset="images/portfolio/dating_app.png 1x, images/portfolio/dating_app.png 2x" alt="">
                            </div>
                            <div class="entry__info">
                                <h4 class="entry__title">Dating App</h4>
                                <div class="entry__cat">UI/UX Design</div>
                            </div>
                        </a>
                    ...
                    <div class="column entry">
                        <a href="images/portfolio/milgec_1.png" class="entry__link glightbox" data-glightbox="title: White Knit Cap; description: .entry__desc-01">
                            <div class="entry__thumb">
                                <img src="images/portfolio/milgec_1.png" srcset="images/portfolio/milgec_1.png 1x, images/portfolio/milgec_1.png 2x" alt="">
                            </div>
                            <div class="entry__info">
                                <h4 class="entry__title">Milgec</h4>
                                <div class="entry__cat">UI/UX Design</div>
                            </div>
                        </a>
                    ...
                    <div class="column entry">
                        <a href="images/portfolio/dating_app.png" class="entry__link glightbox" data-glightbox="title: White Knit Cap; description: .entry__desc-01">
                            <div class="entry__thumb">
                                <img src="images/portfolio/dating_app.png" srcset="images/portfolio/dating_app.png 1x, images/portfolio/dating_app.png 2x" alt="">
                            </div>
                            <div class="entry__info">
            ...
            <footer id="footer" class="s-footer target-section">
                    ...
                    <div class="column xl-6 md-12 s-footer__block s-footer__site-links">
                        <div class="row">
                            <div class="column xl-4 lg-5 md-6 tab-12">
                                <h5>Follow Me</h5>
                                <ul class="link-list">
                                    <li><a href="https://www.instagram.com/imamd_30/">Instagram</a></li>
                                    <li><a href="https://dribbble.com/imam_d">Dribbble</a></li>
                                    <li><a href="https://github.com/hyoudou123">Github</a></li>
                                </ul>
                            </div>
                            <div class="column xl-6 md-6 tab-12">
                                <h5>Contact Me</h5>
                                <ul class="link-list">
                                    <li><a href="mailto:imamd898@gmail.com">imamd898@gmail.com</a></li>
                                    <li><a href="tel:+6287725846004">+62 877 2584 6004</a></li>
                                </ul> 
                            </div>
                        </div>                    
                ...
                <div class="row s-footer__buttons">
                    ...
                    <div class="column xl-6 tab-12">
                        <a href="mailto:imamd898@gmail.com" class="btn btn--primary btn--large u-fullwidth">Message Me</a>
                    </div>
                        ...
                        <ul class="s-footer__social social-list">
                            <li>
                                <a href="#0">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="22px" height="22px" viewBox="0 0 22 21" version="1.1">
                                        <g id="surface1">
                                            <path style=" stroke:none;fill-rule:evenodd;fill:rgb(40%,40%,40%);fill-opacity:1;" d="M 10.96875 0 C 4.902344 0 0 4.8125 0 10.765625 C 0 15.523438 3.140625 19.554688 7.5 20.980469 C 8.042969 21.085938 8.242188 20.746094 8.242188 20.464844 C 8.242188 20.214844 8.226562 19.359375 8.226562 18.464844 C 5.175781 19.109375 4.539062 17.183594 4.539062 17.183594 C 4.050781 15.933594 3.324219 15.613281 3.324219 15.613281 C 2.324219 14.953125 3.394531 14.953125 3.394531 14.953125 C 4.503906 15.027344 5.085938 16.058594 5.085938 16.058594 C 6.066406 17.699219 7.644531 17.238281 8.28125 16.953125 C 8.371094 16.257812 8.660156 15.773438 8.96875 15.507812 C 6.535156 15.257812 3.976562 14.332031 3.976562 10.195312 C 3.976562 9.019531 4.414062 8.058594 5.101562 7.308594 C 4.992188 7.039062 4.613281 5.9375 5.210938 4.457031 C 5.210938 4.457031 6.136719 4.171875 8.226562 5.5625 C 9.121094 5.324219 10.042969 5.207031 10.96875 5.203125 C 11.894531 5.203125 12.835938 5.328125 13.707031 5.5625 C 15.796875 4.171875 16.722656 4.457031 16.722656 4.457031 C 17.324219 5.9375 16.941406 7.039062 16.832031 7.308594 C 17.539062 8.058594 17.957031 9.019531 17.957031 10.195312 C 17.957031 14.332031 15.398438 15.238281 12.945312 15.507812 C 13.347656 15.847656 13.691406 16.488281 13.691406 17.503906 C 13.691406 18.949219 13.671875 20.105469 13.671875 20.460938 C 13.671875 20.746094 13.871094 21.085938 14.417969 20.980469 C 18.773438 19.554688 21.917969 15.523438 21.917969 10.765625 C 21.933594 4.8125 17.011719 0 10.96875 0 Z M 10.96875 0 "/>
                                        </g>
                                    </svg>
                                    <span class="u-screen-reader-text">Github</span>
                                </a>
